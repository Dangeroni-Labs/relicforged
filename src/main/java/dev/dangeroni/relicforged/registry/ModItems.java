...
public final class ModItems {
    ...
    public static final RegistryObject<Item> BLACKENED_SWORD = ITEMS.register("blackened_sword", () -> new SwordItem(BlackenedTier.INSTANCE, 3, -2.4F, new Item.Properties()));
